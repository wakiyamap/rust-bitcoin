...
mod tests {
    ...
    fn sanity() {
        ...
        let addr = create_address(&secp, Network::MonacoinTestnet, &contract, keys, &alpha_template!()).unwrap();
        assert_eq!(addr.to_string(), "pGHsx2PsNMnehUxHwKzxwo19yz3gmQfgqd".to_owned());
    }
