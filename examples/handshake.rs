...
use monacoin::network::{address, constants, message, message_network};
use monacoin::network::stream_reader::StreamReader;
use monacoin::secp256k1;
use monacoin::secp256k1::rand::Rng;
...
fn main() {
    ...
    let first_message = message::RawNetworkMessage {
        magic: constants::Network::Monacoin.magic(),
